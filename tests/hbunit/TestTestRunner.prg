...
CLASS TestTestRunner FROM TestRunner
...
METHOD new() CLASS TestTestRunner
...
METHOD addResults( ... ) CLASS TestTestRunner
...
METHOD showResults( oResult ) CLASS TestTestRunner
